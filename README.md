...
<p>
  ...
  <img src="https://img.shields.io/badge/MCP-89%20tools-7c3aed" alt="MCP: 89 tools" />
...
- **An MCP server** (`zaptrace-mcp`) that exposes 89 agent-facing tools to AI agents.
...
| MCP server (89 tools) | ✅ Implemented |
