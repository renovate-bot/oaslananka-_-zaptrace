...
class KiCadOracle:
    ...
    def run_erc(
        ...
        *,
        ...
        base.report_path = _portable_path_text(out)
        base.report_sha256 = _sha256_if_readable(out)
        ...
        try:
            ...
            if out.exists():
                ...
                parsed = self._parse_erc_json(raw)
                ...
                parsed.report_path = _portable_path_text(out)
                parsed.report_sha256 = _sha256_if_readable(out)
                base = parsed
